...
{
    public class HolidayPackageTourMasterDTO
    {
        ...
        public string HolidayPackageDetail { get; set; }

        public List<HolidayPackageTourDetailDTO> HolidayPackageTourInfoDetailList = new List<HolidayPackageTourDetailDTO>();
